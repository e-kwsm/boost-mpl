...
template <int bit_size> class big_int
{
    // ...
};

template <int bit_size> struct integer
{
    ...
    typedef typename mpl::base<typename mpl::lower_bound<
        ...
        mpl::int_<bit_size>>::type>::type iter_;

    typedef typename mpl::end<builtins_>::type last_;
    typedef typename mpl::eval_if<boost::is_same<iter_, last_>,
                                  mpl::identity<big_int<bit_size>>,
                                  mpl::deref<iter_>>::type type;
};
