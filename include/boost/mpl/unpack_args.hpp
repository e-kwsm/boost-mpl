...
#define AUX778076_UNPACK(unused, i, Args) , typename at_c<Args, i>::type /**/
...
#define BOOST_PP_ITERATION_PARAMS_1                                            \
    (3,                                                                        \
     (0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <boost/mpl/unpack_args.hpp>))
...
#else
        : aux::unpack_args_impl<size<Args>::value>::template apply<F, Args>
#endif
    {
...
struct unpack_args_impl<i_, F, Args>
    : BOOST_PP_CAT(apply, i_)<F AUX778076_UNPACKED_ARGS(i_, Args)>
{
};
...
{
    template <typename F, typename Args>
    struct apply : BOOST_PP_CAT(apply, i_)<F AUX778076_UNPACKED_ARGS(i_, Args)>
    {
    };
};
