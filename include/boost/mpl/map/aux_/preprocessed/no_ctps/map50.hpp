...
template <> struct m_item_impl<41>
{
...
template <> struct m_item_impl<42>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<43>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<44>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<45>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<46>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<47>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<48>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<49>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
...
template <> struct m_item_impl<50>
{
    template <typename Key, typename T, typename Base>
    struct result_ : m_item_<Key, T, Base>
    {
