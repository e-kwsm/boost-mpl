...
template <> struct at_impl<aux::vector_tag<41>>
{
...
template <> struct front_impl<aux::vector_tag<41>>
{
    template <typename Vector> struct apply
    {
...
template <> struct back_impl<aux::vector_tag<41>>
{
    template <typename Vector> struct apply
    {
...
template <> struct empty_impl<aux::vector_tag<41>>
{
...
template <> struct size_impl<aux::vector_tag<41>>
{
    template <typename Vector> struct apply : long_<41>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<41>> : size_impl<aux::vector_tag<41>>
{
};

template <> struct clear_impl<aux::vector_tag<41>>
{
    template <typename Vector> struct apply
    {
...
template <> struct at_impl<aux::vector_tag<42>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<42>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<42>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<42>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<42>>
{
    template <typename Vector> struct apply : long_<42>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<42>> : size_impl<aux::vector_tag<42>>
{
};

template <> struct clear_impl<aux::vector_tag<42>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<43>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<43>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<43>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<43>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<43>>
{
    template <typename Vector> struct apply : long_<43>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<43>> : size_impl<aux::vector_tag<43>>
{
};

template <> struct clear_impl<aux::vector_tag<43>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<44>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<44>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<44>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<44>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<44>>
{
    template <typename Vector> struct apply : long_<44>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<44>> : size_impl<aux::vector_tag<44>>
{
};

template <> struct clear_impl<aux::vector_tag<44>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<45>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<45>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<45>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<45>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<45>>
{
    template <typename Vector> struct apply : long_<45>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<45>> : size_impl<aux::vector_tag<45>>
{
};

template <> struct clear_impl<aux::vector_tag<45>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<46>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<46>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<46>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<46>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<46>>
{
    template <typename Vector> struct apply : long_<46>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<46>> : size_impl<aux::vector_tag<46>>
{
};

template <> struct clear_impl<aux::vector_tag<46>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<47>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<47>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<47>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<47>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<47>>
{
    template <typename Vector> struct apply : long_<47>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<47>> : size_impl<aux::vector_tag<47>>
{
};

template <> struct clear_impl<aux::vector_tag<47>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<48>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<48>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<48>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<48>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<48>>
{
    template <typename Vector> struct apply : long_<48>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<48>> : size_impl<aux::vector_tag<48>>
{
};

template <> struct clear_impl<aux::vector_tag<48>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<49>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<49>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<49>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<49>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<49>>
{
    template <typename Vector> struct apply : long_<49>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<49>> : size_impl<aux::vector_tag<49>>
{
};

template <> struct clear_impl<aux::vector_tag<49>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<50>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<50>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<50>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<50>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<50>>
{
    template <typename Vector> struct apply : long_<50>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<50>> : size_impl<aux::vector_tag<50>>
{
};

template <> struct clear_impl<aux::vector_tag<50>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
