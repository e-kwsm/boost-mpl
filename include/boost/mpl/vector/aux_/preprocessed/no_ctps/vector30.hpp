...
template <> struct at_impl<aux::vector_tag<21>>
{
...
template <> struct front_impl<aux::vector_tag<21>>
{
    template <typename Vector> struct apply
    {
...
template <> struct back_impl<aux::vector_tag<21>>
{
    template <typename Vector> struct apply
    {
...
template <> struct empty_impl<aux::vector_tag<21>>
{
...
template <> struct size_impl<aux::vector_tag<21>>
{
    template <typename Vector> struct apply : long_<21>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<21>> : size_impl<aux::vector_tag<21>>
{
};

template <> struct clear_impl<aux::vector_tag<21>>
{
    template <typename Vector> struct apply
    {
...
template <> struct at_impl<aux::vector_tag<22>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<22>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<22>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<22>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<22>>
{
    template <typename Vector> struct apply : long_<22>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<22>> : size_impl<aux::vector_tag<22>>
{
};

template <> struct clear_impl<aux::vector_tag<22>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<23>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<23>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<23>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<23>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<23>>
{
    template <typename Vector> struct apply : long_<23>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<23>> : size_impl<aux::vector_tag<23>>
{
};

template <> struct clear_impl<aux::vector_tag<23>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<24>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<24>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<24>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<24>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<24>>
{
    template <typename Vector> struct apply : long_<24>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<24>> : size_impl<aux::vector_tag<24>>
{
};

template <> struct clear_impl<aux::vector_tag<24>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<25>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<25>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<25>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<25>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<25>>
{
    template <typename Vector> struct apply : long_<25>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<25>> : size_impl<aux::vector_tag<25>>
{
};

template <> struct clear_impl<aux::vector_tag<25>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<26>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<26>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<26>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<26>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<26>>
{
    template <typename Vector> struct apply : long_<26>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<26>> : size_impl<aux::vector_tag<26>>
{
};

template <> struct clear_impl<aux::vector_tag<26>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<27>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<27>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<27>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<27>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<27>>
{
    template <typename Vector> struct apply : long_<27>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<27>> : size_impl<aux::vector_tag<27>>
{
};

template <> struct clear_impl<aux::vector_tag<27>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<28>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<28>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<28>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<28>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<28>>
{
    template <typename Vector> struct apply : long_<28>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<28>> : size_impl<aux::vector_tag<28>>
{
};

template <> struct clear_impl<aux::vector_tag<28>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<29>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<29>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<29>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<29>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<29>>
{
    template <typename Vector> struct apply : long_<29>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<29>> : size_impl<aux::vector_tag<29>>
{
};

template <> struct clear_impl<aux::vector_tag<29>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
...
template <> struct at_impl<aux::vector_tag<30>>
{
    template <typename V_, typename N> struct apply
    {
        typedef typename aux::v_at_impl<BOOST_MPL_AUX_VALUE_WKND(
...
template <> struct front_impl<aux::vector_tag<30>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::item0 type;
...
template <> struct back_impl<aux::vector_tag<30>>
{
    template <typename Vector> struct apply
    {
        typedef typename Vector::back type;
...
template <> struct empty_impl<aux::vector_tag<30>>
{
    template <typename Vector> struct apply : false_
    {
    };
...
template <> struct size_impl<aux::vector_tag<30>>
{
    template <typename Vector> struct apply : long_<30>
    {
    };
};

template <>
struct O1_size_impl<aux::vector_tag<30>> : size_impl<aux::vector_tag<30>>
{
};

template <> struct clear_impl<aux::vector_tag<30>>
{
    template <typename Vector> struct apply
    {
        typedef vector0<> type;
