...
template <typename Predicate, typename LastIterator> struct iter_fold_if_pred
{
    ...
    struct apply
        ...
        : and_<not_<is_same<Iterator, LastIterator>>,
               apply1<Predicate, Iterator>>
    {
#else
    {
        typedef and_<not_<is_same<Iterator, LastIterator>>,
                     apply1<Predicate, Iterator>>
            type;
#endif
    };
...
struct iter_fold_if
{
    ...
    typedef
        typename eval_if<is_na<BackwardPredicate>,
                         if_<is_na<BackwardOp>, always<false_>, always<true_>>,
                         identity<BackwardPredicate>>::type backward_pred_;
...
// cwpro8 doesn't like 'cut-off' type here (use typedef instead)
  ...
  public:
    ...
    BOOST_MPL_AUX_LAMBDA_SUPPORT(6, iter_fold_if,
