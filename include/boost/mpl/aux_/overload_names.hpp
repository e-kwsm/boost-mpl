...
#define BOOST_MPL_AUX_OVERLOAD_CALL_VALUE_BY_KEY(T, x)                         \
    BOOST_MPL_AUX_PTR_TO_REF(T) / x
#define BOOST_MPL_AUX_OVERLOAD_CALL_ITEM_BY_ORDER(T, x)                        \
    BOOST_MPL_AUX_PTR_TO_REF(T) | x
#define BOOST_MPL_AUX_OVERLOAD_CALL_ORDER_BY_KEY(T, x)                         \
    BOOST_MPL_AUX_PTR_TO_REF(T) || x
...
#define BOOST_MPL_AUX_OVERLOAD_CALL_VALUE_BY_KEY(T, x)                         \
    T::BOOST_MPL_AUX_OVERLOAD_VALUE_BY_KEY(BOOST_MPL_AUX_PTR_TO_REF(T), x)
#define BOOST_MPL_AUX_OVERLOAD_CALL_ITEM_BY_ORDER(T, x)                        \
    T::BOOST_MPL_AUX_OVERLOAD_ITEM_BY_ORDER(BOOST_MPL_AUX_PTR_TO_REF(T), x)
#define BOOST_MPL_AUX_OVERLOAD_CALL_ORDER_BY_KEY(T, x)                         \
    T::BOOST_MPL_AUX_OVERLOAD_ORDER_BY_KEY(BOOST_MPL_AUX_PTR_TO_REF(T), x)
#define BOOST_MPL_AUX_OVERLOAD_CALL_IS_MASKED(T, x)                            \
    T::BOOST_MPL_AUX_OVERLOAD_IS_MASKED(BOOST_MPL_AUX_PTR_TO_REF(T), x)
