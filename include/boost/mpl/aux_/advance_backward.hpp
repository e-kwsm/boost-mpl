...
template <BOOST_MPL_AUX_NTTP_DECL(long, N)> struct advance_backward
{
    ...
    {
        typedef
            typename apply_wrap1<advance_backward<BOOST_MPL_LIMIT_UNROLLING>,
                                 Iterator>::type chunk_result_;

        typedef typename apply_wrap1<
            advance_backward<((N - BOOST_MPL_LIMIT_UNROLLING) < 0
                                  ? 0
...
template <> struct advance_backward<BOOST_PP_FRAME_ITERATION(1)>
{
    template <typename Iterator> struct apply
    {
...
#define BOOST_PP_ITERATION_PARAMS_2                                            \
    (3, (1, BOOST_PP_FRAME_ITERATION(1),                                       \
         <boost/mpl/aux_/advance_backward.hpp>))
#include BOOST_PP_ITERATE()
#endif
