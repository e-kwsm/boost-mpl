...
#define AUX778076_ITER_FOLD_STEP(unused, i, unused2)                           \
    typedef                                                                    \
        typename apply2<ForwardOp, BOOST_PP_CAT(state, i),                     \
                        AUX778076_FOLD_IMPL_OP(BOOST_PP_CAT(iter, i))>::type   \
            BOOST_PP_CAT(state, BOOST_PP_INC(i));                              \
    typedef typename mpl::next<BOOST_PP_CAT(iter, i)>::type BOOST_PP_CAT(      \
        iter, BOOST_PP_INC(i));                                                \
    /**/
...
/// forward declaration
template <BOOST_MPL_AUX_NTTP_DECL(int, N), typename First, typename Last,
          typename State, typename ForwardOp>
...
struct AUX778076_FOLD_IMPL_NAME
{
    typedef AUX778076_FOLD_IMPL_NAME<BOOST_MPL_LIMIT_UNROLLING, First, Last,
                                     State, ForwardOp>
        chunk_;
    ...
    typedef AUX778076_FOLD_IMPL_NAME<
        ...
        typename chunk_::iterator, Last, typename chunk_::state, ForwardOp>
        res_;
...
struct AUX778076_FOLD_IMPL_NAME<-1, First, Last, State, ForwardOp>
    : AUX778076_FOLD_IMPL_NAME<
          ...
          typename apply2<ForwardOp, State,
                          AUX778076_FOLD_IMPL_OP(First)>::type,
          ForwardOp>
{
};
...
template <BOOST_MPL_AUX_NTTP_DECL(int, N), typename Last, typename State,
          typename ForwardOp>
...
template <BOOST_MPL_AUX_NTTP_DECL(int, N)> struct AUX778076_FOLD_CHUNK_NAME;
...
template <BOOST_MPL_AUX_NTTP_DECL(int, N)> struct AUX778076_FOLD_CHUNK_NAME
{
    ...
    struct result_
    {
        ...
        typedef AUX778076_FOLD_IMPL_NAME<((N - BOOST_MPL_LIMIT_UNROLLING) < 0
                                              ? 0
                                              : N - BOOST_MPL_LIMIT_UNROLLING),
                                         typename chunk_::iterator, Last,
...
template <> struct AUX778076_FOLD_CHUNK_NAME<-1>
{
    ...
    struct result_
    {
        typedef typename if_<typename is_same<First, Last>::type,
                             ...
                             State>,
            BOOST_PP_CAT(AUX778076_FOLD_IMPL_NAME_PREFIX,
                         _step)<First, Last, State, ForwardOp> > ::type res_;
