...
#define BOOST_MPL_AUX_INSERTER_ALGORITHM_DEF(arity, name)                      \
    ...
    template <BOOST_MPL_PP_DEFAULT_PARAMS(arity, typename P, na)>              \
    struct name : aux::name##_impl<BOOST_MPL_PP_PARAMS(arity, P)>              \
    {                                                                          \
    };                                                                         \
                                                                               \
    template <BOOST_MPL_PP_PARAMS(BOOST_PP_DEC(arity), typename P)>            \
    struct name<BOOST_MPL_PP_PARAMS(BOOST_PP_DEC(arity), P), na>               \
        : if_<has_push_back<typename clear<P1>::type>,                         \
              aux::name##_impl<BOOST_MPL_PP_PARAMS(BOOST_PP_DEC(arity), P),    \
                               back_inserter<typename clear<P1>::type>>,       \
              aux::reverse_##name##_impl<                                      \
                  BOOST_MPL_PP_PARAMS(BOOST_PP_DEC(arity), P),                 \
                  front_inserter<typename clear<P1>::type>>>::type             \
    {                                                                          \
    };                                                                         \
                                                                               \
    template <BOOST_MPL_PP_DEFAULT_PARAMS(arity, typename P, na)>              \
...
#define BOOST_MPL_AUX_INSERTER_ALGORITHM_DEF(arity, name)                      \
    ...
    {                                                                          \
                                                                               ...
                                                                               \
    template <BOOST_MPL_PP_DEFAULT_PARAMS(arity, typename P, na)> struct name  \
    {                                                                          \
        typedef typename eval_if<                                              \
            is_na<BOOST_PP_CAT(P, arity)>,                                     \
            def_##name##_impl<BOOST_MPL_PP_PARAMS(BOOST_PP_DEC(arity), P)>,    \
            aux::name##_impl<BOOST_MPL_PP_PARAMS(arity, P)>>::type type;       \
    };                                                                         \
                                                                               \
    template <BOOST_MPL_PP_PARAMS(BOOST_PP_DEC(arity), typename P)>            \
    ...
    {                                                                          \
        typedef typename eval_if<                                              \
            is_na<BOOST_PP_CAT(P, arity)>,                                     \
            def_reverse_##name##_impl<BOOST_MPL_PP_PARAMS(BOOST_PP_DEC(arity), \
                                                          P)>,                 \
            aux::reverse_##name##_impl<BOOST_MPL_PP_PARAMS(arity, P)>>::type   \
            type;                                                              \
    };                                                                         \
    BOOST_MPL_AUX_NA_SPEC(arity, name)                                         \
    BOOST_MPL_AUX_NA_SPEC(arity, reverse_##name)                               \
