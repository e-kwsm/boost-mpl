...
template <typename Iterator1, typename LastIterator1, typename Iterator2>
struct joint_iter
{
...
template <typename LastIterator1, typename Iterator2>
...
template <typename L1, typename I2> struct next<joint_iter<L1, L1, I2>>
{
...
template <typename Iterator1, typename LastIterator1, typename Iterator2>
struct joint_iter : joint_iter_impl<is_same<Iterator1, LastIterator1>::value>::
