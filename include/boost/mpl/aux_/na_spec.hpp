...
#define BOOST_MPL_AUX_NA_SPEC_ARITY(i, name)                                   \
    ...
    struct arity<name<BOOST_MPL_AUX_NA_PARAMS(i)>, N>                          \
...
#define BOOST_MPL_AUX_NA_SPEC_MAIN(i, name)                                    \
    template <> struct name<BOOST_MPL_AUX_NA_PARAMS(i)>                        \
    {                                                                          \
        template <BOOST_MPL_PP_PARAMS(i, typename T)                           \
                      BOOST_MPL_PP_NESTED_DEF_PARAMS_TAIL(i, typename T, na)>  \
        struct apply : name<BOOST_MPL_PP_PARAMS(i, T)>                         \
        {                                                                      \
        };                                                                     \
    };                                                                         \
    /**/
...
#define BOOST_MPL_AUX_NA_SPEC_LAMBDA(i, name)                                  \
    template <> struct lambda<name<BOOST_MPL_AUX_NA_PARAMS(i)>, void_, true_>  \
    {                                                                          \
        typedef false_ is_le;                                                  \
        typedef name<BOOST_MPL_AUX_NA_PARAMS(i)> type;                         \
    };                                                                         \
    template <> struct lambda<name<BOOST_MPL_AUX_NA_PARAMS(i)>, void_, false_> \
    {                                                                          \
        typedef false_ is_le;                                                  \
        typedef name<BOOST_MPL_AUX_NA_PARAMS(i)> type;                         \
    };                                                                         \
...
#define BOOST_MPL_AUX_NA_SPEC_LAMBDA(i, name)                                  \
    ...
    struct lambda<name<BOOST_MPL_AUX_NA_PARAMS(i)>,                            \
                  Tag BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(int_<-1>)>              \
    {                                                                          \
        typedef false_ is_le;                                                  \
...
#define BOOST_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(i, j, name)                       \
    ...
    struct template_arity<name<BOOST_MPL_PP_PARAMS(j, T)>> : int_<j>           \
    {                                                                          \
    };                                                                         \
                                                                               \
    template <>                                                                \
    struct template_arity<name<BOOST_MPL_PP_ENUM(i, na)>> : int_<-1>           \
    {                                                                          \
    };                                                                         \
    }                                                                          \
/**/
...
#define BOOST_MPL_AUX_NA_SPEC_ETI(i, name)                                     \
    template <> struct name<BOOST_MPL_PP_ENUM(i, int)>                         \
    {                                                                          \
        typedef int type;                                                      \
        enum { value = 0 };                                                    \
    };                                                                         \
