...
template <typename F> struct AUX778076_MSVC_DTW_NAME
{
    ...
    template <> struct f_<true>
    {
        ...
        template <AUX778076_DTW_PARAMS(typename P)>
    ...
    template <AUX778076_DTW_PARAMS(typename T)>
    struct result_
    ...
    struct result_ : f_<aux::msvc_never_true<F>::value>::
