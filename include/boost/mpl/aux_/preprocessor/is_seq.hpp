...
//   BOOST_PP_ASSERT( BOOST_MPL_PP_IS_SEQ( (1)(2) ) )
    ...
    defined(_MSC_VER) && defined(__INTEL_COMPILER) && __INTEL_COMPILER == 1010

#define BOOST_MPL_PP_IS_SEQ(seq)                                               \
    BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_MPL_PP_IS_SEQ_(seq)))
#define BOOST_MPL_PP_IS_SEQ_(seq)                                              \
    BOOST_MPL_PP_IS_SEQ_SEQ_(BOOST_MPL_PP_IS_SEQ_SPLIT_ seq)
...
#define BOOST_MPL_PP_IS_SEQ_(seq)                                              \
    BOOST_PP_CAT(BOOST_MPL_PP_IS_SEQ_,                                         \
                 BOOST_MPL_PP_IS_SEQ_0 seq BOOST_PP_RPAREN())
