...
#define BOOST_MPL_PP_EXT_PARAMS_1(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##1, p##2, p##3, p##4, p##5, p##6, p##7,   \
                                   p##8, p##9)
#define BOOST_MPL_PP_EXT_PARAMS_2(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##2, p##3, p##4, p##5, p##6, p##7, p##8,   \
                                   p##9, p1)
#define BOOST_MPL_PP_EXT_PARAMS_3(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##3, p##4, p##5, p##6, p##7, p##8, p##9,   \
                                   p1, p2)
#define BOOST_MPL_PP_EXT_PARAMS_4(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##4, p##5, p##6, p##7, p##8, p##9, p1, p2, \
                                   p3)
#define BOOST_MPL_PP_EXT_PARAMS_5(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##5, p##6, p##7, p##8, p##9, p1, p2, p3, p4)
#define BOOST_MPL_PP_EXT_PARAMS_6(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##6, p##7, p##8, p##9, p1, p2, p3, p4, p5)
#define BOOST_MPL_PP_EXT_PARAMS_7(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##7, p##8, p##9, p1, p2, p3, p4, p5, p6)
#define BOOST_MPL_PP_EXT_PARAMS_8(i, p)                                        \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##8, p##9, p1, p2, p3, p4, p5, p6, p7)
#define BOOST_MPL_PP_EXT_PARAMS_9(i, p)                                        \
...
#define BOOST_MPL_PP_AUX_EXT_PARAM_FUNC(unused, i, op)                         \
    BOOST_PP_COMMA_IF(i)                                                       \
    BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 1, op),                                \
                 BOOST_PP_ADD_D(1, i, BOOST_PP_TUPLE_ELEM(2, 0, op)))          \
    /**/

#define BOOST_MPL_PP_EXT_PARAMS(i, j, param)                                   \
    BOOST_PP_REPEAT(BOOST_PP_SUB_D(1, j, i), BOOST_MPL_PP_AUX_EXT_PARAM_FUNC,  \
                    (i, param))                                                \
    /**/
