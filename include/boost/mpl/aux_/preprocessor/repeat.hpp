...
#define BOOST_MPL_PP_REPEAT_5(f, p)                                            \
    f(0, 0, p) f(0, 1, p) f(0, 2, p) f(0, 3, p) f(0, 4, p)
#define BOOST_MPL_PP_REPEAT_6(f, p)                                            \
    f(0, 0, p) f(0, 1, p) f(0, 2, p) f(0, 3, p) f(0, 4, p) f(0, 5, p)
#define BOOST_MPL_PP_REPEAT_7(f, p)                                            \
    f(0, 0, p) f(0, 1, p) f(0, 2, p) f(0, 3, p) f(0, 4, p) f(0, 5, p) f(0, 6, p)
#define BOOST_MPL_PP_REPEAT_8(f, p)                                            \
    f(0, 0, p) f(0, 1, p) f(0, 2, p) f(0, 3, p) f(0, 4, p) f(0, 5, p)          \
        f(0, 6, p) f(0, 7, p)
#define BOOST_MPL_PP_REPEAT_9(f, p)                                            \
    f(0, 0, p) f(0, 1, p) f(0, 2, p) f(0, 3, p) f(0, 4, p) f(0, 5, p)          \
        f(0, 6, p) f(0, 7, p) f(0, 8, p)
#define BOOST_MPL_PP_REPEAT_10(f, p)                                           \
    f(0, 0, p) f(0, 1, p) f(0, 2, p) f(0, 3, p) f(0, 4, p) f(0, 5, p)          \
        f(0, 6, p) f(0, 7, p) f(0, 8, p) f(0, 9, p)
