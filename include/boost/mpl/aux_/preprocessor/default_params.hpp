...
#define BOOST_MPL_PP_DEFAULT_PARAMS_4(p, v)                                    \
    p##1 = v, p##2 = v, p##3 = v, p##4 = v
#define BOOST_MPL_PP_DEFAULT_PARAMS_5(p, v)                                    \
    p##1 = v, p##2 = v, p##3 = v, p##4 = v, p##5 = v
#define BOOST_MPL_PP_DEFAULT_PARAMS_6(p, v)                                    \
    p##1 = v, p##2 = v, p##3 = v, p##4 = v, p##5 = v, p##6 = v
#define BOOST_MPL_PP_DEFAULT_PARAMS_7(p, v)                                    \
    p##1 = v, p##2 = v, p##3 = v, p##4 = v, p##5 = v, p##6 = v, p##7 = v
#define BOOST_MPL_PP_DEFAULT_PARAMS_8(p, v)                                    \
    p##1 = v, p##2 = v, p##3 = v, p##4 = v, p##5 = v, p##6 = v, p##7 = v,      \
    p##8 = v
#define BOOST_MPL_PP_DEFAULT_PARAMS_9(p, v)                                    \
    p##1 = v, p##2 = v, p##3 = v, p##4 = v, p##5 = v, p##6 = v, p##7 = v,      \
    p##8 = v, p##9 = v
...
#define BOOST_MPL_PP_DEFAULT_PARAMS(n, param, value)                           \
    BOOST_PP_REPEAT(n, BOOST_MPL_PP_AUX_DEFAULT_PARAM_FUNC, (param, value))    \
    /**/
