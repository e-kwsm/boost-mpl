...
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_IMPL(i, param, value_func)                \
    BOOST_MPL_PP_DEF_PARAMS_TAIL_DELAY_1(                                      \
        i, BOOST_MPL_PP_SUB(BOOST_MPL_LIMIT_METAFUNCTION_ARITY, i), param,     \
        value_func)                                                            \
    /**/
...
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_0(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##1 v(), p##2 v(), p##3 v(), p##4 v(),     \
                                   p##5 v(), p##6 v(), p##7 v(), p##8 v(),     \
                                   p##9 v())
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_1(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##2 v(), p##3 v(), p##4 v(), p##5 v(),     \
                                   p##6 v(), p##7 v(), p##8 v(), p##9 v(), p1)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_2(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##3 v(), p##4 v(), p##5 v(), p##6 v(),     \
                                   p##7 v(), p##8 v(), p##9 v(), p1, p2)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_3(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##4 v(), p##5 v(), p##6 v(), p##7 v(),     \
                                   p##8 v(), p##9 v(), p1, p2, p3)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_4(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##5 v(), p##6 v(), p##7 v(), p##8 v(),     \
                                   p##9 v(), p1, p2, p3, p4)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_5(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##6 v(), p##7 v(), p##8 v(), p##9 v(), p1, \
                                   p2, p3, p4, p5)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_6(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##7 v(), p##8 v(), p##9 v(), p1, p2, p3,   \
                                   p4, p5, p6)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_7(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##8 v(), p##9 v(), p1, p2, p3, p4, p5, p6, \
                                   p7)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_8(i, p, v)                                \
    BOOST_MPL_PP_FILTER_PARAMS_##i(p##9 v(), p1, p2, p3, p4, p5, p6, p7, p8)
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_9(i, p, v)                                \
...
#define BOOST_MPL_PP_DEF_PARAMS_TAIL_IMPL(i, param, value_func)                \
    BOOST_PP_REPEAT(BOOST_PP_SUB_D(1, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, i),  \
                    BOOST_MPL_PP_AUX_TAIL_PARAM_FUNC, (i, param, value_func))  \
    /**/
