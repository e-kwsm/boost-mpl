...
#define BOOST_MPL_PP_TOKEN_EQUAL(a, b)                                         \
    BOOST_PP_IIF(                                                              \
        BOOST_PP_BITAND(BOOST_MPL_PP_IS_SEQ(BOOST_PP_CAT(                      \
                            BOOST_MPL_PP_TOKEN_EQUAL_, a)((unused))),          \
                        BOOST_MPL_PP_IS_SEQ(BOOST_PP_CAT(                      \
                            BOOST_MPL_PP_TOKEN_EQUAL_, b)((unused)))),         \
        BOOST_MPL_PP_TOKEN_EQUAL_I, 0 BOOST_PP_TUPLE_EAT(2))(a, b) /**/

#define BOOST_MPL_PP_TOKEN_EQUAL_I(a, b)                                       \
    BOOST_PP_COMPL(BOOST_MPL_PP_IS_SEQ(                                        \
        BOOST_MPL_PP_TOKEN_EQUAL_##a(BOOST_MPL_PP_TOKEN_EQUAL_##b)((unused)))) \
    /**/
