...
#define AUX778076_COUNT_ARGS_TEMPLATE_PARAM                                    \
    typename AUX778076_COUNT_ARGS_PARAM_NAME
#endif
...
#define AUX778076_COUNT_ARGS_PARAMS(param)                                     \
    BOOST_MPL_PP_PARAMS(AUX778076_COUNT_ARGS_ARITY, param)                     \
    /**/
...
#define AUX778076_COUNT_ARGS_PARAMS(param)                                     \
    BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_PP_INC(AUX778076_COUNT_ARGS_ARITY),     \
                                 param)                                        \
    /**/
...
#define AUX778076_COUNT_ARGS_FUNC(unused, i, param)                            \
    BOOST_PP_EXPR_IF(i, +)                                                     \
    AUX778076_IS_ARG_TEMPLATE_NAME<BOOST_PP_CAT(param,                         \
                                                BOOST_PP_INC(i))>::value /**/
...
template <> struct AUX778076_IS_ARG_TEMPLATE_NAME<AUX778076_COUNT_ARGS_DEFAULT>
{
    BOOST_STATIC_CONSTANT(bool, value = false);
};

// <xxx>_count_args
template <AUX778076_COUNT_ARGS_PARAMS(AUX778076_COUNT_ARGS_TEMPLATE_PARAM)>
