...
#define AUX778076_SEQUENCE_PARAMS()                                            \
    BOOST_PP_ENUM_PARAMS(AUX778076_SEQUENCE_LIMIT,                             \
                         AUX778076_SEQUENCE_TEMPLATE_PARAM)                    \
    /**/

#define AUX778076_SEQUENCE_ARGS()                                              \
    BOOST_PP_ENUM_PARAMS(AUX778076_SEQUENCE_LIMIT, T)                          \
    /**/

#define AUX778076_SEQUENCE_DEFAULT_PARAMS()                                    \
    BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(AUX778076_SEQUENCE_LIMIT,              \
                                        AUX778076_SEQUENCE_TEMPLATE_PARAM,     \
...
#define AUX778076_SEQUENCE_N_PARTIAL_SPEC_ARGS(n)                              \
    BOOST_PP_ENUM_PARAMS(n, T)                                                 \
    BOOST_PP_COMMA_IF(n)                                                       \
    BOOST_PP_ENUM(BOOST_PP_SUB_D(1, AUX778076_SEQUENCE_LIMIT, n),              \
                  BOOST_PP_TUPLE_ELEM_3_2, AUX778076_SEQUENCE_DEFAULT)         \
    /**/
...
#define AUX778076_SEQUENCE_PARAMS()                                            \
    typename T, BOOST_PP_ENUM_PARAMS(AUX778076_SEQUENCE_LIMIT,                 \
                                     AUX778076_SEQUENCE_TEMPLATE_PARAM) /**/

#define AUX778076_SEQUENCE_ARGS()                                              \
    T, BOOST_PP_ENUM_PARAMS(AUX778076_SEQUENCE_LIMIT, C) /**/
...
#define AUX778076_SEQUENCE_N_PARTIAL_SPEC_ARGS(n)                              \
    T, BOOST_PP_ENUM_PARAMS(n, C) BOOST_PP_COMMA_IF(n) BOOST_PP_ENUM(          \
...
// forward declaration
template <AUX778076_SEQUENCE_DEFAULT_PARAMS()> struct AUX778076_SEQUENCE_NAME;
#else
namespace aux {
...
template <AUX778076_SEQUENCE_PARAMS()>
struct BOOST_PP_CAT(AUX778076_SEQUENCE_NAME, _impl)
{
    typedef aux::BOOST_PP_CAT(AUX778076_SEQUENCE_NAME,
                              _count_args)<BOOST_PP_ENUM_PARAMS(
        AUX778076_SEQUENCE_LIMIT, AUX778076_SEQUENCE_PARAM_NAME)> arg_num_;

    typedef typename aux::BOOST_PP_CAT(AUX778076_SEQUENCE_NAME, _chooser)<
        arg_num_::value>::template result_<AUX778076_SEQUENCE_ARGS()>::type
        type;
};

} // namespace aux

template <AUX778076_SEQUENCE_DEFAULT_PARAMS()>
struct AUX778076_SEQUENCE_NAME
    : aux::BOOST_PP_CAT(AUX778076_SEQUENCE_NAME,
                        _impl)<AUX778076_SEQUENCE_ARGS()>::type
{
    typedef
        typename aux::BOOST_PP_CAT(AUX778076_SEQUENCE_NAME,
                                   _impl)<AUX778076_SEQUENCE_ARGS()>::type type;
};
...
template <AUX778076_SEQUENCE_N_PARAMS(i_)>
struct AUX778076_SEQUENCE_NAME
    : AUX778076_SEQUENCE_NAME_N(i_)<AUX778076_SEQUENCE_N_ARGS(i_)>
{
    typedef typename AUX778076_SEQUENCE_NAME_N(
        i_)<AUX778076_SEQUENCE_N_ARGS(i_)>::type type;
};
    ...
    : AUX778076_SEQUENCE_NAME_N(i_)<AUX778076_SEQUENCE_N_ARGS(i_)>
{
    ...
    typedef typename AUX778076_SEQUENCE_NAME_N(
        i_)<AUX778076_SEQUENCE_N_ARGS(i_)>::type type;
#else
    typedef AUX778076_SEQUENCE_NAME_N(
        i_)<AUX778076_SEQUENCE_N_ARGS(i_)>::type type;
#endif
};
...
template <> struct BOOST_PP_CAT(AUX778076_SEQUENCE_NAME, _chooser)<i_>
{
    template <AUX778076_SEQUENCE_PARAMS()> struct result_
    {
#if i_ > 0 || defined(AUX778076_SEQUENCE_INTEGRAL_WRAPPER)
        typedef typename AUX778076_SEQUENCE_NAME_N(
            i_)<AUX778076_SEQUENCE_N_ARGS(i_)>::type type;
