...
#define BOOST_PP_ITERATION_PARAMS_1                                            \
    (3, (1, BOOST_MPL_LIMIT_METAFUNCTION_ARITY,                                \
...
#define AUX778076_LAMBDA_TYPEDEF(unused, i_, F)                                \
    typedef lambda<typename F::BOOST_PP_CAT(arg, BOOST_PP_INC(i_)), Tag,       \
                   false_>                                                     \
...
template <> struct lambda_impl<int_<i_>>
{
    template <typename F, typename Tag, typename Protect> struct result_
    {
        ...
        typedef aux::lambda_or<BOOST_MPL_PP_REPEAT(i_, AUX778076_IS_LAMBDA_EXPR,
                                                   unused)>
            is_le;

        typedef BOOST_PP_CAT(bind, i_)<typename F::rebind BOOST_MPL_PP_REPEAT(
            i_, AUX778076_LAMBDA_RESULT, unused)> bind_;
