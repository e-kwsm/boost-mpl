...
template <typename T> struct msvc_is_incomplete
{
...
#else
    template <typename U> static char (&tester(type_wrapper<U>))[sizeof(U) + 1];
#endif

    BOOST_STATIC_CONSTANT(bool, value = sizeof(tester(type_wrapper<T>())) == 1);
};

template <> struct msvc_is_incomplete<int>
{
...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF_(trait, name, default_)              \
    ...
    {                                                                          \
        ...
        BOOST_STATIC_CONSTANT(                                                 \
            bool, value = sizeof(test(static_cast<void (*)(name)>(0))) !=      \
    ...
    template <typename T, typename fallback_ = boost::mpl::bool_<default_>>    \
        struct trait                                                           \
        : boost::mpl::if_c<boost::mpl::aux::msvc_is_incomplete<T>::value,      \
                           boost::mpl::bool_<false>,                           \
                           BOOST_PP_CAT(trait, _impl) < T> > ::type            \
    {                                                                          \
    };                                                                         \
                                                                               \
...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF(trait, name, default_)               \
    template <typename T> struct BOOST_PP_CAT(trait, _msvc_sfinae_helper)      \
    {                                                                          \
        typedef void type;                                                     \
    };                                                                         \
                                                                               \
    ...
    template <typename T>                                                      \
        struct BOOST_PP_CAT(                                                   \
            trait,                                                             \
            _impl_)<T, typename BOOST_PP_CAT(trait, _msvc_sfinae_helper) <     \
    ...
    {                                                                          \
        ...
        typedef boost::mpl::bool_<value> type;                                 \
                                                                               ...
                                                                               \
    template <typename T, typename fallback_ = boost::mpl::bool_<default_>>    \
    struct trait : BOOST_PP_CAT(trait, _impl_)<T>                              \
    {                                                                          \
    };                                                                         \
    /**/
...
#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_BCB_DEF(trait, trait_tester, name,       \
                                              default_)                        \
    template <typename T, bool IS_CLASS> struct trait_tester                   \
    {                                                                          \
        BOOST_STATIC_CONSTANT(bool, value = false);                            \
    };                                                                         \
    template <typename T> struct trait_tester<T, true>                         \
    {                                                                          \
        struct trait_tester_impl                                               \
        {                                                                      \
            template <class U>                                                 \
            static int                                                         \
            resolve(boost::mpl::aux::type_wrapper<U> const volatile *,         \
                    boost::mpl::aux::type_wrapper<typename U::name> * = 0);    \
            static char resolve(...);                                          \
        };                                                                     \
        typedef boost::mpl::aux::type_wrapper<T> t_;                           \
        BOOST_STATIC_CONSTANT(bool,                                            \
                              value = (sizeof(trait_tester_impl::resolve(      \
                                           static_cast<t_ *>(0))) ==           \
                                       sizeof(int)));                          \
    };                                                                         \
    template <typename T, typename fallback_ = boost::mpl::bool_<default_>>    \
    ...
    {                                                                          \
        BOOST_STATIC_CONSTANT(                                                 \
            bool,                                                              \
            value = (trait_tester<T, boost::is_class<T>::value>::value));      \
        typedef boost::mpl::bool_<trait<T, fallback_>::value> type;            \
    };

#define BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF(trait, name, default_)               \
    BOOST_MPL_HAS_XXX_TRAIT_NAMED_BCB_DEF(trait, BOOST_PP_CAT(trait, _tester), \
                                          name, default_)                      \
    /**/
    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            static boost::mpl::aux::yes_tag test(                              \
                ...
                boost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name> * = \
                    0);                                                        \
                                                                               \
        ...
        typedef boost::mpl::aux::type_wrapper<T> t_;                           \
        BOOST_STATIC_CONSTANT(                                                 \
            bool, value = sizeof(gcc_3_2_wknd::test(static_cast<t_ *>(0))) ==  \
...
#define BOOST_MPL_HAS_MEMBER_MULTI_SUBSTITUTE(z, n, args)                      \
    template <template <BOOST_PP_ENUM_PARAMS_Z(z, BOOST_PP_INC(n),             \
                                               typename V)> class V>           \
...
#define BOOST_MPL_HAS_MEMBER_SUBSTITUTE(args, substitute_macro)                \
    BOOST_PP_REPEAT(BOOST_PP_ARRAY_ELEM(2, args),                              \
                    BOOST_MPL_HAS_MEMBER_MULTI_SUBSTITUTE, args)               \
    /**/
    ...
    static boost::mpl::aux::yes_tag                                            \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)(                    \
            ...
            BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME(args, n) <      \
                V::template BOOST_PP_ARRAY_ELEM(1, args) > * = 0);             \
    /**/
#define BOOST_MPL_HAS_MEMBER_ACCEPT(args, member_macro)                        \
    BOOST_PP_REPEAT(BOOST_PP_ARRAY_ELEM(2, args),                              \
                    BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT, args)                   \
    /**/
#else
#define BOOST_MPL_HAS_MEMBER_ACCEPT(args, member_macro)                        \
    template <typename V>                                                      \
    static boost::mpl::aux::yes_tag                                            \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)(                    \
            V const volatile *, member_macro(args, V, T) * = 0);               \
    /**/
#endif
...
#if !BOOST_MPL_HAS_XXX_NO_WRAPPED_TYPES
#define BOOST_MPL_HAS_MEMBER_TEST(args)                                        \
    sizeof(BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)(                 \
        static_cast<boost::mpl::aux::type_wrapper<U> *>(0))) ==                \
        sizeof(boost::mpl::aux::yes_tag) /**/
#else
#define BOOST_MPL_HAS_MEMBER_TEST(args)                                        \
    sizeof(BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)(                 \
        static_cast<U *>(0))) == sizeof(boost::mpl::aux::yes_tag) /**/
#endif
#endif

#define BOOST_MPL_HAS_MEMBER_INTROSPECT(args, substitute_macro, member_macro)  \
    template <typename U> struct BOOST_MPL_HAS_MEMBER_INTROSPECTION_NAME(args) \
    {                                                                          \
...
#define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION(args, introspect_macro,            \
                                            substitute_macro, member_macro)    \
    template <typename T, typename fallback_ =                                 \
                              boost::mpl::bool_<BOOST_PP_ARRAY_ELEM(3, args)>> \
    class BOOST_PP_ARRAY_ELEM(0, args)                                         \
    {                                                                          \
      introspect_macro(args, substitute_macro, member_macro) public            \
          : static const bool value =                                          \
                BOOST_MPL_HAS_MEMBER_INTROSPECTION_NAME(args)<T>::value;       \
        typedef typename BOOST_MPL_HAS_MEMBER_INTROSPECTION_NAME(              \
            args)<T>::type type;                                               \
    };                                                                         \
    /**/
...
#define BOOST_MPL_HAS_MEMBER_WITH_FUNCTION_SFINAE(args, substitute_macro,      \
                                                  member_macro)                \
    BOOST_MPL_HAS_MEMBER_IMPLEMENTATION(args, BOOST_MPL_HAS_MEMBER_INTROSPECT, \
                                        substitute_macro, member_macro)        \
    /**/
...
#define BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME_WITH_TEMPLATE_SFINAE( \
    args, n)                                                                     \
    BOOST_PP_CAT(boost_mpl_has_xxx_,                                             \
                 BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME(args, n))    \
    /**/
#endif

#define BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(args)             \
    BOOST_PP_CAT(                                                                \
...
#define BOOST_MPL_HAS_MEMBER_MULTI_SUBSTITUTE_WITH_TEMPLATE_SFINAE(z, n, args)   \
    template <template <BOOST_PP_ENUM_PARAMS_Z(z, BOOST_PP_INC(n),               \
                                               typename U)> class U>             \
    struct                                                                       \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME_WITH_TEMPLATE_SFINAE( \
            args, n)                                                             \
    {                                                                            \
        typedef BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(          \
            args) type;                                                          \
    };                                                                           \
    /**/

#define BOOST_MPL_HAS_MEMBER_SUBSTITUTE_WITH_TEMPLATE_SFINAE(args,             \
                                                             substitute_macro) \
    typedef void BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(args); \
    BOOST_PP_REPEAT(                                                           \
        BOOST_PP_ARRAY_ELEM(2, args),                                          \
        BOOST_MPL_HAS_MEMBER_MULTI_SUBSTITUTE_WITH_TEMPLATE_SFINAE, args)      \
    /**/

#define BOOST_MPL_HAS_MEMBER_REJECT_WITH_TEMPLATE_SFINAE(args, member_macro)   \
    template <typename U,                                                      \
              typename V =                                                     \
                  BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(      \
                      args)>                                                   \
...
#define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT_WITH_TEMPLATE_SFINAE(z, n, args)                    \
    template <typename U>                                                                     \
        struct BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)<                            \
            U,                                                                                \
            typename BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME_WITH_TEMPLATE_SFINAE( \
                args, n) <                                                                    \
...
#define BOOST_MPL_HAS_MEMBER_ACCEPT_WITH_TEMPLATE_SFINAE(args, member_macro)   \
    BOOST_PP_REPEAT(BOOST_PP_ARRAY_ELEM(2, args),                              \
...
#define BOOST_MPL_HAS_MEMBER_WITH_TEMPLATE_SFINAE(args, substitute_macro,      \
                                                  member_macro)                \
    BOOST_MPL_HAS_MEMBER_SUBSTITUTE_WITH_TEMPLATE_SFINAE(args,                 \
                                                         substitute_macro)     \
    BOOST_MPL_HAS_MEMBER_IMPLEMENTATION(                                       \
        args, BOOST_MPL_HAS_MEMBER_INTROSPECT_WITH_TEMPLATE_SFINAE,            \
        substitute_macro, member_macro)                                        \
    /**/
...
#define BOOST_MPL_HAS_XXX_TEMPLATE_DEF(name)                                   \
    BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(BOOST_PP_CAT(has_, name), name,       \
                                         false)                                \
    /**/
