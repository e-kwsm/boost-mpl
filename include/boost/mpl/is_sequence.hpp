...
// would fail; requiring 'T' to have _both_ 'tag' and 'begin' members
// workarounds the issue for most real-world cases
template <typename T>
struct is_sequence_impl
    : and_<identity<aux::has_tag<T>>, identity<aux::has_begin<T>>>
{
};
...
#endif
                         ,
                         aux::is_sequence_impl<T>, bool_<false>>::type
{
...
template <typename BOOST_MPL_AUX_NA_PARAM(T)> struct is_sequence : bool_<false>
{
};
...
template <> struct is_sequence<int> : bool_<false>
{
};
#endif
