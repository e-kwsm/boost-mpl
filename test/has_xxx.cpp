...
struct c2
{
    template <typename T1, typename T2> struct xxx
    {
    };
};
struct c3
{
    template <typename T1, typename T2, typename T3> struct xxx
    {
    };
};
struct c4
{
    template <typename T1, typename T2, typename T3, typename T4> struct xxx
    {
    };
};
struct c5
...
struct c7
{
    template <typename T1, typename T2> struct yyy
    {
    };
};
