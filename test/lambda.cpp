...
MPL_TEST_CASE()
{
    ...
    typedef lambda<
        or_<and_<not_<boost::is_same<_1, char>>, not_<boost::is_float<_1>>>,
            greater<sizeof_<_1>, mpl::size_t<8>>>>::type f;
...
MPL_TEST_CASE()
{
    ...
    typedef lambda<or_<boost::is_same<_1, _2>, boost::is_same<_2, my>,
                       equal_to<sizeof_<_1>, sizeof_<_2>>>>::type f;
