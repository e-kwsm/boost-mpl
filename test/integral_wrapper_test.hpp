...
#define CONSTEXPR_INTEGRAL_TEST(T, i)                                          \
    {                                                                          \
        static_assert(T() == i, "Constexpr for integral constant failed");     \
    }
#endif
...
#define INTEGRAL_WRAPPER_TEST(unused1, i, T)                                   \
    {                                                                          \
        ...
        {                                                                      \
            typedef is_same<borland_tested_type::value_type, T>                \
                borland_test_type;                                             \
        ...
        {                                                                      \
            MPL_ASSERT((                                                       \
                is_same<next<borland_tested_type>::type, WRAPPER(T, i + 1)>)); \
        }                                                                      \
        {                                                                      \
            MPL_ASSERT((is_same<prior<borland_tested_type>::type,              \
                                WRAPPER(T, i - 1)>));                          \
        }                                                                      \
        {                                                                      \
