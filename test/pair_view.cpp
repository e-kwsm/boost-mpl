...
MPL_TEST_CASE()
{
    using r = range_c<int,0,10>;
    using v = vector10_c<int,9,8,7,6,5,4,3,2,1,10>;
    
    using view = pair_view<r,v>;
    using first_ = begin<view>::type;
    using last_ = end<view>::type;
    ...
    using iter = advance_c<first_,5>::type;
