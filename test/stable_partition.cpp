...
using numbers = vector_c<int,3,4,0,-5,8,-1,7>::type;
using manual_first = vector_c<int,0,-5,-1>::type;
using manual_second = vector_c<int,3,4,8,7>::type;

MPL_TEST_CASE()
{
    using result = stable_partition<
          numbers
        , less< _, int_<3> >
        >::type;
